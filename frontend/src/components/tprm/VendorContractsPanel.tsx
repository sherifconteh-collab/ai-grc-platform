...
// Vendor contracts, renewals and quick scoring. Formerly its own page at
// /dashboard/vendor-risk; now the Contracts tab of Third-Party Risk.
export default function VendorContractsPanel() {
    ...
    <>
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            <h2 className="text-xl font-semibold text-gray-900">Vendor contracts</h2>
