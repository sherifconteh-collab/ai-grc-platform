...
const navigationSections: NavigationSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Evidence', href: '/dashboard/evidence', icon: '📄', requiredPermissions: ['evidence.read'], minTier: 'starter' },
      { name: 'Assessments', href: '/dashboard/assessments', icon: '📋', requiredPermissions: ['assessments.read'] },
      { name: 'Reports', href: '/dashboard/reports', icon: '📑', requiredPermissions: ['reports.read'], minTier: 'starter' },
  ...
  },
  {
    label: 'Assets & Risk',
    items: [
      { name: 'Assets', href: '/dashboard/assets', icon: '🏗️', requiredPermissions: ['assets.read'], minTier: 'starter' },
      { name: 'Vulnerabilities', href: '/dashboard/vulnerabilities', icon: '🛡️', requiredPermissions: ['assets.read'], minTier: 'starter' },
      { name: 'SBOM', href: '/dashboard/sbom', icon: '📦', requiredPermissions: ['assets.read'], minTier: 'professional' },
      { name: 'Security Posture', href: '/dashboard/security-posture', icon: '🛡️', requiredPermissions: ['ai.use'], minTier: 'starter' },
      { name: 'Threat Intelligence', href: '/dashboard/threat-intel', icon: '🎯', requiredPermissions: ['assets.read'], minTier: 'professional' },
      { name: 'Vendor Risk', href: '/dashboard/vendor-risk', icon: '🤝', requiredPermissions: ['organizations.read'], minTier: 'starter' },
      { name: 'Third-Party Risk', href: '/dashboard/tprm', icon: '🔗', requiredPermissions: ['organizations.read'], minTier: 'professional' },
      { name: 'Financial Compliance', href: '/dashboard/cmdb/financial-services-workspace', icon: '🏦', requiredPermissions: ['assets.read'], minTier: 'utilities' },
    ],
  },
  {
    label: 'AI & Intelligence',
    items: [
      { name: 'AI Analysis', href: '/dashboard/ai-analysis', icon: '✨', requiredPermissions: ['ai.use'], minTier: 'starter' },
      { name: 'AI Monitoring', href: '/dashboard/ai-monitoring', icon: '🤖', requiredPermissions: ['settings.manage'], minTier: 'starter' },
      { name: 'AI Governance', href: '/dashboard/ai-governance', icon: '🏛️', requiredPermissions: ['organizations.read'], minTier: 'professional' },
      { name: 'Knowledge Base', href: '/dashboard/knowledge-base', icon: '📚', requiredPermissions: ['ai.use'], minTier: 'professional' },
      { name: 'Regulatory News', href: '/dashboard/regulatory-news', icon: '📰', requiredPermissions: ['organizations.read'], minTier: 'starter' },
    ],
  },
  {
    label: 'Organization',
    items: [
      ...
      { name: 'Data Governance', href: '/dashboard/data-governance', icon: '🔒', requiredPermissions: ['settings.manage'], minTier: 'professional' },
