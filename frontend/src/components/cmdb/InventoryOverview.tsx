...
// The CMDB overview (asset types, counts, advanced tools). Formerly the separate
// /dashboard/cmdb hub; now a section of the Assets page.
export default function InventoryOverview() {
  ...
  return (
    <section id="inventory" aria-labelledby="inventory-heading" className="space-y-6 scroll-mt-20">
      <div>
        <h2 id="inventory-heading" className="text-xl font-semibold text-gray-900">Inventory by type (CMDB)</h2>
        <p className="text-gray-600 mt-1">Track every asset, its owner, and its relationships.</p>
      </div>
