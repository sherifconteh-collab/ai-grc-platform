...
CREATE TABLE IF NOT EXISTS org_delegated_admins (
...
CREATE INDEX IF NOT EXISTS idx_delegated_admins_parent ON org_delegated_admins (parent_org_id);
CREATE INDEX IF NOT EXISTS idx_delegated_admins_child  ON org_delegated_admins (child_org_id);
CREATE INDEX IF NOT EXISTS idx_delegated_admins_user   ON org_delegated_admins (user_id);
